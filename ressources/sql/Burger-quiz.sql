...
--
-- Host: localhost
-- Generation Time: Oct 03, 2022 at 04:32 PM
...
CREATE TABLE `answer` (
  `id` int(11) NOT NULL,
  `question-id` int(11) UNSIGNED NOT NULL,
  `answer` varchar(255) NOT NULL,
  `answer-check` tinyint(1) NOT NULL
...
INSERT INTO `answer` (`id`, `question-id`, `answer`, `answer-check`) VALUES
...
ALTER TABLE `answer`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_question_id_question_id` (`question-id`);
...
--
ALTER TABLE `answer`
  ADD CONSTRAINT `fk_question_id_question_id` FOREIGN KEY (`question-id`) REFERENCES `question` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
